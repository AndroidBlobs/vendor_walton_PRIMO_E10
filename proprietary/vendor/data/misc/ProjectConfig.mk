...
#redmine 173979 wangyang modify for testBatchAndFlush test failed 20190428 begin
CUSTOM_KERNEL_PS = yes
#CUSTOM_KERNEL_ALS = yes
#CUSTOM_KERNEL_ALSPS = yes
#redmine 173979 wangyang modify for testBatchAndFlush test failed 20190428 end
...
#redmine 172763 wangyang modify for close LovelyFonts 20190411 begin
LOVELYFONTS_SUPPORT = no
#redmine 172763 wangyang modify for close LovelyFonts 20190411 end
...
MTK_BUILD_VERNO = Primo_E10_S06_16072019
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#wangyang modify for release key begin
...
#redmine 173979 wangyang modify for testAllComponentInstantiation error 20190428 begin
MTK_WMA_PLAYBACK_SUPPORT = no
#redmine 173979 wangyang modify for testAllComponentInstantiation error 20190428 end
...
pcb_config = VP516E_AH5161W_Walton

sagereal_battery_capacity  =  battery_4350mV_2000mAh_650ma_VP516E_AH5161W

sagereal_memory_flash  = EMMC_64_4_ddr2_VP516E_AH5161W 

sagereal_tee_support = TRUSTKERNEL_TEE_6_20_MT6580

sagereal_tee_cert= mt6580_VP516E_AH5161W_Walton

sagereal_audio_effect_para = VP516E_AH5161W_Walton

#wangyang modify for fingerprint do not have space begin
SAGEREAL_PRODUCT_NAME = PRIMO_E10
SAGEREAL_TARGET_DEVICE = PRIMO_E10
#redmine 179091 wangyang modify for model\wifi name 20190601 begin
#redmine 179091 wangyang modify must much tee 20190603 begin
SAGEREAL_MODEL_NAME = PRIMO%space%E10
#redmine 179091 wangyang modify must much tee 20190603 end
#redmine 179091 wangyang modify for model\wifi name 20190601 end
SAGEREAL_BOARD_NAME = WALTON
#wangyang modify for fingerprint do not have space begin

#redmine 167104 wangyang modify for Build nomenclature 20190326 begin
TARGET_BOOTLOADER_BOARD_NAME = WALTON
SAGEREAL_PRODUCT_MANUFACTURER = WALTON
#redmine 167104 wangyang modify for Build nomenclature 20190326 end

#Redmine 126296 huangxinxin modify for add GMS and widevine 2017-03-17 begin
SAGEREAL_WIDEVINE_SUPPORT = yes

BUILD_GMS = yes
#Redmine 126296 huangxinxin modify for add GMS and widevine 2017-03-17 end

#redmine 167555	 jiangqiao add the new factorydevelopx 2019/3/6 begin
SAGEREAL_FACTORYDEVELOPX_SUPPORT = no
#redmine 167555	 jiangqiao add the new factorydevelopx 2019/3/6 end
...
#redmine 166465 wangyang add for GMS make use one of gms\gms_go\eea_common begin
#eg if no please NONE
#eg gms_eea_type1 gms_eea_type2 gms_eea_type3a gms_eea_type3b gms_eea_type4a gms_eea_type4b gms_eea_type4c
#eg if BUILD_AGO_GMS is yes please use gms_go_eea_type1 gms_go_eea_type2 gms_go_eea_type3a gms_go_eea_type3b gms_go_eea_type4a gms_go_eea_type4b gms_go_eea_type4c
GMS_EEA_TYPE = NONE
#redmine 166465 wangyang add for GMS make use one of gms\gms_go\eea_common end

#redmine 167555 modify for open new factory mode 20190322 begin
SAGEREAL_FACTORYMODE_SUPPORT = yes
#redmine 171955 modify for open factory Gsensor 20190404 begin
SAGEREAL_FACTORYTEST_GSENSOR = yes
#redmine 171955 modify for open factory Gsensor 20190404 end
#redmine 172042 modify for GPS and front camera 20190408 begin
SAGEREAL_FACTORYTEST_FRONTCAMERA = yes
#redmine 172042 modify for GPS and front camera 20190408 end
#redmine 167555 modify for open new factory mode 20190322 end

#redmine 175305 add for face to face test by pengjunjie 2019-05-07 begin
SAGEREAL_FACTORYTEST_PROXSENSOR = yes
#redmine 175305 add for face to face test by pengjunjie 2019-05-07 end

#redmine 167115 wangyang modify for boot animation 20190325 begin
#以下集成宏，如果没有客户需求，请设置为空，避免重复拷贝
sagereal_customer = VP516E_AH5161W_Walton    #ddm kazam mobiwire

#logo,animation
logo_size = fwvga   #wvga qhd hvga fwvga hd
#redmine 167115 wangyang modify for boot animation 20190325 end

#redmine 167117 wangyang modify for custom Walton SalesTraker 20190326 begin
SAGEREAL_WALTON_SALESTRACK_INSTALL = yes
#redmine 167117 wangyang modify for custom Walton SalesTraker 20190326 end

#redmine 173880 wangyang modify for device in PC 20190326 begin
sagereal_pc_name = Primo%space%E10
#redmine 173880 wangyang modify for device in PC 20190326 end

#redmine 167140 wangyang modify for default time is 24 20190223 begin
sagereal_time_12_24 = 12
#redmine 167140 wangyang modify for default time is 24 20190223 end

#redmine 167127 167121 wangyang modify for bluetooth wifi default name 20190327 begin
bluetooth_hostname = Primo_E10
#redmine 179091 wangyang modify for model\wifi name 20190601 begin
wlan_ssid = Primo_E10
#redmine 179091 wangyang modify for model\wifi name 20190601 end
#redmine 167127 167121 wangyang modify for bluetooth wifi default name 20190327 end

#redmine 167127 wangyang modify for ringtone alarm notification 20190404 begin
#默认来电铃声，消息铃声和闹钟铃声,填写资源名称(xxx.mp3)，不允许有空格
SAGEREAL_MULTISIM_RINGTONE = yes
config_ringtone=Lattice.ogg
config_ringtone2=Lattice.ogg
config_notification=Rhea.ogg
config_alarm=Osmium.ogg
#redmine 167127 wangyang modify for ringtone alarm notification 20190404 end

#redmine167117 xuyunlai add for sms sales tracker 2019-04-08 begin
SAGEREAL_SALES_TRACKER_SUPPORT = yes
#redmine167117 xuyunlai add for sms sales tracker 2019-04-08 end

#redmine 167127 wangyang modify for close button default 20190408 begin
def_sound_effects_enabled = false
def_haptic_feedback = false
#redmine 167127 wangyang modify for close button default 20190408 end

#redmine 129809 qianfeifei set wifi default off 20180420 begin
SAGEREAL_DEFAULT_WIFI_OFF = yes
#redmine 129809 qianfeifei set wifi default off 20180420 end

##sunchao set VDF moblieData default fasle begin 2019-01-17 begin
SAGEREAL_MOBILEDATA_DEFAULT_OFF = yes
##sunchao set VDF moblieData default fasle begin 2019-01-17 end

##Redmine 112251 wangxue modify for default vibrate when ringing 2017-11-23 begin
def_vibrate_when_ringing = 1
##Redmine 112251 wangxue modify for default vibrate when ringing 2017-11-23 end

#redmine 175234 midify for user or userdebug frigerprint 20190428 begin
SAGEREAL_FINGERPRINT_INCREMENTAL =
#redmine 175234 midify for user or userdebug frigerprint 20190428 end

#Redmine133830 wangdandan modify for remove location menu 2019-06-04 begin
BAIDU_NLP_SUPPORT = no
#Redmine133830 wangdandan modify for remove location menu 2019-06-04 end
